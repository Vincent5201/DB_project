        ...
        <div className="filter-options">
          <label>
            <input 
                ...
                onChange={handleAroundChange} /> 影印店
          </label>
          <label>
            <input 
                type="checkbox"
                ...
                onChange={handleAroundChange} /> 垃圾車
          </label>
          <label>
            <input 
                type="checkbox"
          ...
          <label>
            <input 
                ...
                onChange={handleAroundChange} /> 便利商店
          </label>
          <label>
            <input 
                type="checkbox"
                ...
                onChange={handleAroundChange} /> 公園
          </label>
          <label>
            <input 
                type="checkbox"
                name="t6"
                checked={aroundChecked.t5}
                onChange={handleAroundChange} /> ATM
          </label>
          <label>
            <input 
                type="checkbox"
                name="t7"
                checked={aroundChecked.t5}
                onChange={handleAroundChange} /> 診所
          </label>
          <label>
            <input 
                type="checkbox"
                name="t8"
                checked={aroundChecked.t5}
                onChange={handleAroundChange} /> 理髮店
          </label>
        </div>
      </div>
    );
