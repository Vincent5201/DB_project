        ...
        <div className="filter-options">
          ...
          <label>
            <input 
                ...
                onChange={handleEquipChange} /> 洗衣機
          </label>
          <label>
            <input 
                type="checkbox"
                ...
                onChange={handleEquipChange} /> 熱水器
          </label>
          <label>
            <input 
                type="checkbox"
          ...
          <label>
            <input 
                ...
                onChange={handleEquipChange} /> 停車位
          </label>
        </div>
      </div>
    );
